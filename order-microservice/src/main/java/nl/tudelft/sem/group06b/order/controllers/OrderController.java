...
public class OrderController {
    ...
    public ResponseEntity<?> setOrderLocation(@RequestBody SetOrderLocationRequestModel request) {
        try {
            orderService.setOrderLocation(request.getOrderId(), request.getLocation());
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.EXPECTATION_FAILED, e.getMessage());
        }
        return ResponseEntity.ok().build();
    ...
    public ResponseEntity<PlaceOrderResponseModel> placeOrder(@RequestBody PlaceOrderRequestModel request) {
        try {
            return ResponseEntity.ok(new PlaceOrderResponseModel(orderService.placeOrder(request.getOrderId())));
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.EXPECTATION_FAILED, e.getMessage());
        }
        return ResponseEntity.ok().build();
    ...
    public ResponseEntity<FetchStoreOrdersResponseModel> fetchStoreOrders(@RequestBody FetchStoreOrdersRequestModel request) {
        try {
            return ResponseEntity.ok(new FetchStoreOrdersResponseModel(orderService.fetchAllStoreOrders(request.getStoreId())));
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.EXPECTATION_FAILED, e.getMessage());
        }
    }
    ...
    public ResponseEntity<AddPizzaResponseModel> addPizza(@RequestBody AddPizzaRequestModel request) {
        try {
            return ResponseEntity.ok(new AddPizzaResponseModel(orderService.addPizza(authManager.getToken(), request.getOrderId(), request.getPizza())));
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.EXPECTATION_FAILED, e.getMessage());
        }
    }
    ...
    public ResponseEntity<AddToppingResponseModel> addTopping(@RequestBody AddToppingRequestModel request) {
        try {
            return ResponseEntity.ok(new AddToppingResponseModel(orderService.addTopping(authManager.getToken(), request.getOrderId(), request.getPizza(), request.getToppingId())));
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.EXPECTATION_FAILED, e.getMessage());
        }
    }
